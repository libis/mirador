...
/* SPA
      if (_this.getItem(this.sessionID)) {
        this.currentConfig = JSON.parse(_this.getItem(sessionID));
      } else {
*/        
...
// SPA geen local storage nodig!!
//      _this.setItem(_this.sessionID, JSON.stringify(_this.cleanup(_this.currentConfig)));
    }
