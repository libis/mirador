...
//SPA
  stringifyRelatedMan: function(obj) {
    var _this = this,
        format;

    if (obj != '') {
        var manurl = '<a href="' + obj + '"  target="_blank">'+obj+'</a><button class="button button1" onclick="copyURL(\''+obj+'\')">COPY LINK</button>  ';
      return manurl;
...
//SPA
  stringifyRelatedDragAndDrop: function(obj) {
    var _this = this,
        format;

    if (obj != '') {
        var manurl = '<a href=\"'+obj+'?manifest='+obj+'\"><img src=\"images/International_Image_Interoperability_Framework_logo.png\" height=\"50\" width=\"50\" alt=\"IIIF Drag-n-drop\"/></a>';
      return manurl;
    }
    ...
    return [
      {
        ...
        //SPA
        value: this.stringifyRelatedMan(jsonLd['@id'] || '')
      }, {
        identifier: 'manifest',
        label: i18next.t('draganddropmanifest'),
        //SPA
        value: this.stringifyRelatedDragAndDrop(jsonLd['@id'] || '')
      }, {
        identifier: 'within',
